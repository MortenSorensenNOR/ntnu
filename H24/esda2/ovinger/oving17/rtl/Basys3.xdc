...
# set_property PACKAGE_PIN V13 [get_ports {ByteLED[4]}]					
# 	set_property IOSTANDARD  LVCMOS33 [get_ports {ByteLED[4]}]
# set_property PACKAGE_PIN V3  [get_ports {ByteLED[5]}]					
# 	set_property IOSTANDARD  LVCMOS33 [get_ports {ByteLED[5]}]
# set_property PACKAGE_PIN W3  [get_ports {ByteLED[6]}]					
# 	set_property IOSTANDARD  LVCMOS33 [get_ports {ByteLED[6]}]
# set_property PACKAGE_PIN U3  [get_ports {ByteLED[7]}]					
...
##Buttons
# 0 -> top, 1 -> left, 2 -> center, 3 -> right, 4 -> down
