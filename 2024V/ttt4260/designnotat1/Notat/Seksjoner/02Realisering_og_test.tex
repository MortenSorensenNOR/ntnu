...
Velger et potensiometer med målt maksverdi på $R \approx 10.65k\Omega$, og løser for $R_1$ og $R_2$.
...
frekvens $f = 1000$Hz, og hadde en sampling rate på $4 \cdot 10^6$Hz og hver måling 
varte i 2ms.
